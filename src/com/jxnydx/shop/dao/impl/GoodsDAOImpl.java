...
public class GoodsDAOImpl extends AbstractDAOImpl implements IGoodsDAO {
	...
	@Override
	public List<Goods> findAllByStatus(Integer status, Integer currentPage, Integer lineSize, String column,
	...
	public boolean doUpdateStatus(Set<Integer> ids, Integer status) throws Exception {
		...
		while(iter.hasNext()) {
			...
			super.pstmt.setInt(2, (Integer)iter.next());
	...
	public Set<String> findAllByPhoto(Set<Integer> ids) throws Exception {
		if(ids.size() > 0) {
			return super.photoHandle("goods", "photo", "gid", ids);
		}
		return null;
	}

	@Override
	public List<Goods> findAllByItem(Integer iid, Integer status, Integer currentPage, Integer lineSize, String column,
			String keyWord) throws Exception {
